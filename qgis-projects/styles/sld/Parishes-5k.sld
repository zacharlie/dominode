    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#960046</se:SvgParameter>
        ...
        <se:Rule>
          <se:TextSymbolizer>
            <se:Label>
              <!--SE Export for 'Parish of ' + NAME not implemented yet-->Placeholder</se:Label>
            <se:Font>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#8a0055</se:SvgParameter>
            </se:Fill>
