...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="1" minScale="100000000">
  ...
  <labeling type="rule-based">
    <rules key="{af96fdb1-aa24-446c-962a-33076a1948b6}">
      <rule key="{d27837a2-17ee-4bc4-83c8-23874894e09a}">
        <settings calloutType="simple">
          <text-style fieldName="&quot;NAME&quot; + ' Beach'" fontFamily="Ubuntu" textOrientation="horizontal" textColor="0,0,0,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="6" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" previewBkgrdColor="255,255,255,255" textOpacity="1">
  ...
  <aliases>
    ...
    <alias name="" field="LOCATION" index="2"/>
    <alias name="" field="LENGTH" index="3"/>
    <alias name="" field="WIDTH" index="4"/>
    <alias name="" field="COLOUR" index="5"/>
    <alias name="" field="MATERIAL" index="6"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="LOCATION" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="LENGTH" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="WIDTH" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="COLOUR" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="NAME" hidden="0" width="163"/>
      <column type="field" name="LOCATION" hidden="0" width="189"/>
      ...
      <column type="field" name="MATERIAL" hidden="0" width="136"/>
