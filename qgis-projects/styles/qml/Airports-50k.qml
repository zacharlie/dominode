...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="1" minScale="100000000">
  ...
  <labeling type="rule-based">
    <rules key="{3a083954-9c1d-434d-95db-e1ba140dca23}">
      <rule description="Airport" filter="ELSE" key="{2859ce0c-6f38-4d06-bed7-0d0f4f2b3f90}">
        <settings calloutType="simple">
          <text-style fieldName="NAME" fontFamily="Ubuntu" textOrientation="horizontal" textColor="0,0,0,255" multilineHeight="2" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="10" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1">
          ...
          <placement placement="1" priority="5" maxCurvedCharAngleOut="-25" rotationAngle="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" quadOffset="3" offsetType="0" repeatDistanceUnits="MM" overrunDistance="0" yOffset="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" placementFlags="10" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" repeatDistance="0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" overrunDistanceUnit="MM" fitInPolygonOnly="0" xOffset="-2"/>
