...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="1" minScale="100000000">
    ...
    <symbols>
      <symbol type="fill" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          ...
          <prop k="line_color" v="177,204,180,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{d0f11390-9e18-41c9-a09a-6f9deb262c94}">
      <rule filter="ELSE" key="{2c10ae1a-d514-4eb0-9ecc-70e0de4f52e9}">
        <settings calloutType="simple">
          <text-style fieldName="NAMES" fontFamily="Ubuntu" textOrientation="horizontal" textColor="39,103,58,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="12" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1">
  ...
  <customproperties>
    <property key="dualview/previewExpressions" value="NAMES"/>
  ...
  <aliases>
    ...
    <alias name="" field="NAMES" index="3"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="NAMES" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="fid" exp=""/>
    <constraint desc="" field="AREA" exp=""/>
    <constraint desc="" field="PERIMETER" exp=""/>
    <constraint desc="" field="NAMES" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="NAMES" hidden="0" width="250"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="NAMES" labelOnTop="0"/>
    <field name="PERIMETER" labelOnTop="0"/>
    <field name="fid" labelOnTop="0"/>
  </labelOnTop>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>NAMES</previewExpression>
  <mapTip></mapTip>
