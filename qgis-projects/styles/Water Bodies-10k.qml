...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="1" minScale="100000000">
  ...
  <labeling type="rule-based">
    <rules key="{fe6aec68-c011-4fb2-8081-a78df9cf4a1a}">
      <rule description="All Features" filter="ELSE" scalemaxdenom="25000" key="{3854c568-3dfa-453f-9f03-dec351187691}" scalemindenom="1">
        <settings calloutType="simple">
          <text-style fieldName="NAMES" fontFamily="Ubuntu" textOrientation="horizontal" textColor="105,151,200,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="6" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1">
          ...
          <placement placement="1" priority="5" maxCurvedCharAngleOut="-25" rotationAngle="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" quadOffset="5" offsetType="0" repeatDistanceUnits="MM" overrunDistance="0" yOffset="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" placementFlags="5" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" repeatDistance="500" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" overrunDistanceUnit="MM" fitInPolygonOnly="0" xOffset="0"/>
  ...
  <aliases>
    ...
    <alias name="" field="NAMES" index="4"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="NAMES" hidden="0" width="209"/>
