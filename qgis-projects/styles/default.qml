...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" minScale="100000000">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="Label" fontFamily="Z003 [UKWN]" textOrientation="horizontal" textColor="55,100,155,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="24" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="1" fontWordSpacing="0" namedStyle="Medium Italic" fontStrikeout="0" fontWeight="57" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1">
      ...
      <placement placement="0" priority="5" maxCurvedCharAngleOut="-25" rotationAngle="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" quadOffset="4" offsetType="0" repeatDistanceUnits="MM" overrunDistance="0" yOffset="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" placementFlags="6" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="1" repeatDistance="0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="50" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" overrunDistanceUnit="MM" fitInPolygonOnly="0" xOffset="0"/>
      <rendering upsidedownLabels="0" fontLimitPixelSize="0" obstacleFactor="1" limitNumLabels="0" drawLabels="1" displayAll="0" mergeLines="0" minFeatureSize="0" obstacle="1" fontMaxPixelSize="10000" scaleMax="0" maxNumLabels="2000" scaleVisibility="0" labelPerPart="0" scaleMin="0" fontMinPixelSize="3" obstacleType="1" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
            <Option type="Map" name="LabelDistance">
              ...
              <Option type="QString" name="expression" value="IF ( &quot;Label&quot; ILIKE 'Caribbean Sea', 50, 10)"/>
  ...
  <aliases>
    ...
    <alias name="" field="Label" index="1"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="Label" hidden="0" width="-1"/>
    </columns>
