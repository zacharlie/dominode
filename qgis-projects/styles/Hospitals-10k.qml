...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="1" minScale="100000000">
  ...
  <labeling type="rule-based">
    <rules key="{d3b95f90-09d6-419e-89c0-5fd0cc448c09}">
      <rule description="Hospital" filter="ELSE" scalemaxdenom="25000" key="{264bb480-6dc9-453b-9629-ac0ac2ce0d73}" scalemindenom="1">
        <settings calloutType="simple">
          <text-style fieldName="CASE WHEN &quot;NAME&quot; is not null THEN &quot;NAME&quot; + ' Hospital'&#xa;else 'Hospital'&#xa;end" fontFamily="Ubuntu" textOrientation="horizontal" textColor="0,0,0,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="6" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="1" previewBkgrdColor="255,255,255,255" textOpacity="1">
          ...
          <placement placement="1" priority="5" maxCurvedCharAngleOut="-25" rotationAngle="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" quadOffset="5" offsetType="0" repeatDistanceUnits="MM" overrunDistance="0" yOffset="-0.5" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" placementFlags="10" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistance="0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" overrunDistanceUnit="MM" fitInPolygonOnly="0" xOffset="3.4"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="NAME" hidden="0" width="185"/>
