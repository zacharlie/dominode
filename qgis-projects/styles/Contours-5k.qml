...
<qgis version="3.15.0-Master" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" minScale="100000000">
    ...
    <symbols>
      <symbol type="line" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer class="GeometryGenerator" pass="0" enabled="1" locked="0">
          ...
          <prop k="geometryModifier" v="if(&quot;height&quot; % 100,NULL,$geometry)"/>
          ...
          <symbol type="line" name="@0@0" alpha="1" clip_to_extent="1" force_rhr="0">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              ...
              <prop k="line_color" v="153,119,106,255"/>
        ...
        <layer class="GeometryGenerator" pass="0" enabled="1" locked="0">
          <prop k="SymbolType" v="Line"/>
          <prop k="geometryModifier" v="if((&quot;height&quot;+10) % 20,$geometry,NULL)"/>
          <data_defined_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option name="properties"/>
          ...
          <symbol type="line" name="@0@1" alpha="1" clip_to_extent="1" force_rhr="0">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="199,155,137,255"/>
              <prop k="line_style" v="solid"/>
  ...
  <labeling type="rule-based">
    <rules key="{95c54602-63c3-4ad5-bad4-14da09675d6a}">
      <rule filter="(&quot;height&quot;+10) % 20" key="{4b89ccbb-b258-4baf-818e-7602881c6ceb}">
        <settings calloutType="simple">
          <text-style fieldName="height" fontFamily="Ubuntu" textOrientation="horizontal" textColor="0,0,0,255" multilineHeight="1" fontCapitals="0" allowHtml="0" fontKerning="1" fontSize="10" useSubstitutions="0" blendMode="0" fontLetterSpacing="0" fontItalic="0" fontWordSpacing="0" namedStyle="Regular" fontStrikeout="0" fontWeight="50" fontUnderline="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" previewBkgrdColor="255,255,255,255" textOpacity="1">
          ...
          <text-format wrapChar="" useMaxLineLengthForAutoWrap="1" multilineAlign="0" autoWrapLength="0" decimals="3" reverseDirectionSymbol="0" addDirectionSymbol="0" placeDirectionSymbol="0" plussign="0" formatNumbers="0" rightDirectionSymbol=">" leftDirectionSymbol="&lt;"/>
          <placement placement="2" priority="5" maxCurvedCharAngleOut="-25" rotationAngle="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" quadOffset="4" offsetType="0" repeatDistanceUnits="MM" overrunDistance="0" yOffset="0" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" placementFlags="10" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistance="0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" offsetUnits="MM" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" overrunDistanceUnit="MM" fitInPolygonOnly="0" xOffset="0"/>
